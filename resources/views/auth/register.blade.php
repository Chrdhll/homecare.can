                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            <input id="name" type="text" name="name"
                                class="form-control rounded-pill custom-input" placeholder="Full Name"
                        ...
                        <div class="mb-3">
                            <input id="email" type="email" name="email"
                                class="form-control rounded-pill custom-input" placeholder="Email Address"
                        ...
                        <div class="mb-4 position-relative password-wrapper">
                            <input id="password_confirmation" type="password" name="password_confirmation"
                                class="form-control rounded-pill custom-input" placeholder="Confirm Password" required
                                autocomplete="new-password">
                        ...
                        <div class="d-grid mb-3">
                            <button type="submit" class="btn btn-dark-custom rounded-pill fw-bold py-2">Create
                                Account</button>
                        </div>
                        ...
                        <div class="d-grid">
                            <a href="{{ route('login') }}"
                                class="btn btn-outline-secondary rounded-pill fw-bold py-2">Log in</a>
                        </div>
                    </form>
                </div>
            </div>
