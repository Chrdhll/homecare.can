                ...
                <div class="container text-center" data-aos="fade-up">
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            ...
                            {{-- Judul Error --}}
                            <h1 class="display-1 fw-bold mb-0">419</h1>
                            <h2 class="mb-4">Halaman Expired</h2></h2>

                            {{-- Pesan Penjelasan --}}
                            <p class="mb-4 text-muted lead">
                                Maaf, halaman yang Anda tuju telah kadaluarsa. Silakan kembali ke halaman utama.
                            </p>
